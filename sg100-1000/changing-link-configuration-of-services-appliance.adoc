...
. リンク設定に必要な変更を加えます。
+
オプションの詳細については、を参照してください xref:configuring-network-links-sg100-and-sg1000.adoc[ネットワークリンクを設定する]。
...
+
VLAN 設定を変更した場合は、アプライアンスのサブネットが変更されている可能性があります。アプライアンスの IP アドレスを変更する必要がある場合は、を参照してください xref:configuring-storagegrid-ip-addresses-sg100-and-sg1000.adoc[StorageGRID IP アドレスを設定する]。
